...
static void set_rows_cuda(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
    ...
    } else if (dst->type == GGML_TYPE_Q2_KVARN) {
        set_rows_cuda_quant<idx_t, block_q2_kvarn, QK2_KVARN, quantize_f32_q2_kvarn_block>(
            src0_d, src1_d, (block_q2_kvarn*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
    ...
    } else if (dst->type == GGML_TYPE_Q3_KVARN) {
        set_rows_cuda_quant<idx_t, block_q3_kvarn, QK3_KVARN, quantize_f32_q3_kvarn_block>(
            src0_d, src1_d, (block_q3_kvarn*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
    ...
    } else if (dst->type == GGML_TYPE_Q4_KVARN) {
        set_rows_cuda_quant<idx_t, block_q4_kvarn, QK4_KVARN, quantize_f32_q4_kvarn_block>(
            src0_d, src1_d, (block_q4_kvarn*)dst->data,
            ne00, ne01, ne02, ne03,
            ne10, ne11, ne12, ne13,
            nb01, nb02, nb03,
            nb10, nb11, nb12,
