...
static bool ggml_backend_cuda_device_supports_op(ggml_backend_dev_t dev, const ggml_tensor * op) {
    ...
    switch (op->op) {
        ...
        case GGML_OP_SET_ROWS:
            {
                return (
                           (
                               ...
                               op->type == GGML_TYPE_Q2_KVARN || op->type == GGML_TYPE_Q3_KVARN || op->type == GGML_TYPE_Q4_KVARN) &&
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_Q2_KVARN) {
                    return true;
                }
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_Q2_KVARN_K) {
                    return true;
                }
                if (src0_type == GGML_TYPE_Q2_KVARN_K && src1_type == GGML_TYPE_F32) {
                    return true;
                }
                if (src0_type == GGML_TYPE_Q2_KVARN && src1_type == GGML_TYPE_F32) {
                    return true;
                }
                if (src0_type == GGML_TYPE_F32 && (src1_type == GGML_TYPE_Q3_KVARN   || src1_type == GGML_TYPE_Q4_KVARN ||
                                                   src1_type == GGML_TYPE_Q3_KVARN_K || src1_type == GGML_TYPE_Q4_KVARN_K)) {
                    return true;
                }
                if (src1_type == GGML_TYPE_F32 && (src0_type == GGML_TYPE_Q3_KVARN   || src0_type == GGML_TYPE_Q4_KVARN ||
                                                   src0_type == GGML_TYPE_Q3_KVARN_K || src0_type == GGML_TYPE_Q4_KVARN_K)) {
                    return true;
                }
        ...
        case GGML_OP_KVARN_FA:
            return op->src[0]->ne[0] <= 256; // head_dim; kernel strides channels
