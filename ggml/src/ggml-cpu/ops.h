...
void ggml_compute_forward_kvarn_varn(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_kvarn_fa(const struct ggml_compute_params * params, struct ggml_tensor * dst);
