...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_Q2_KVARN] = {
        .from_float               = quantize_row_q2_kvarn,
    },
    [GGML_TYPE_Q2_KVARN_K] = {
        .from_float               = quantize_row_q2_kvarn_k,
    },
    [GGML_TYPE_Q3_KVARN] = {
        .from_float               = quantize_row_q3_kvarn,
    },
    [GGML_TYPE_Q3_KVARN_K] = {
        .from_float               = quantize_row_q3_kvarn_k,
    },
    [GGML_TYPE_Q4_KVARN] = {
        .from_float               = quantize_row_q4_kvarn,
    },
    [GGML_TYPE_Q4_KVARN_K] = {
        .from_float               = quantize_row_q4_kvarn_k,
    },
    [GGML_TYPE_I32] = {
